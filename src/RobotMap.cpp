...
void RobotMap::init()
{
 ...
 driveTalonFL.reset(new CANTalon(IDS::driveFL));
 driveTalonRL.reset(new CANTalon(IDS::driveRL));
 driveTalonFR.reset(new CANTalon(IDS::driveFR));
 driveTalonRR.reset(new CANTalon(IDS::driveRR));
